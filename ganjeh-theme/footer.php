    ...
    <footer class="site-footer">
        ...
        $footer_address = get_theme_mod('ganjeh_footer_address', 'تهران، خ مطهری، نرسیده به خ ترکمنستان پ20');
        $instagram = get_theme_mod('ganjeh_social_instagram', '');
        $telegram = get_theme_mod('ganjeh_social_telegram', '');
        $bale = get_theme_mod('ganjeh_social_bale', '');
        $enamad_code = get_theme_mod('ganjeh_enamad_code', '');
        ?>

        <!-- Enamad Trust Badge -->
        <div class="footer-enamad">
            <div class="enamad-title"><?php _e('نماد اعتماد الکترونیکی', 'ganjeh'); ?></div>
            <div class="enamad-badge">
                ...
                <?php else : ?>
                    <div class="enamad-placeholder">
                        ...
                        <span><?php _e('اینماد', 'ganjeh'); ?></span>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="footer-social">
            ...
            <div class="social-links">
                <?php if ($instagram) : ?>
                <a href="<?php echo esc_url($instagram); ?>" class="social-link instagram" target="_blank" rel="noopener" title="اینستاگرام">
                ...
                <?php endif; ?>
                <?php if ($telegram) : ?>
                <a href="<?php echo esc_url($telegram); ?>" class="social-link telegram" target="_blank" rel="noopener" title="تلگرام">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <?php endif; ?>
                <?php if ($bale) : ?>
                <a href="<?php echo esc_url($bale); ?>" class="social-link bale" target="_blank" rel="noopener" title="بله">
                    <svg viewBox="0 0 24 24" fill="currentColor">
